...
let
  ...
  dependencies =  with pythonPackages; with mypkgs; [ acoustics cytoolz dill geometry ism matplotlib numba numpy scintillations streaming scipy streaming turbulence pytest];
